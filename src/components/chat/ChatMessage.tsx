  ...
  if (message.role === 'user') {
    return (
      <div className="flex justify-end mb-3">
        <div className="max-w-[85%] px-3.5 py-2 bg-purple-600 rounded-2xl rounded-br-md text-sm text-white whitespace-pre-wrap">
          {message.content}
        </div>
      </div>
    );
  ...
  return (
    <div className="mb-3">
      <div className="max-w-[95%]">
        {message.content && (
          <div className="px-3.5 py-2 bg-neutral-800 rounded-2xl rounded-bl-md text-sm text-neutral-200 whitespace-pre-wrap">
            {message.content}
          </div>
        )}
